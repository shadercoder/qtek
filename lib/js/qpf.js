...
define('container/List',['require','./Container','knockout','_'],function(require) {
    ...
    var List = Container.derive(function() {
        ...
        return {
            ...
            itemView : ko.observable(null), // item component constructor
...
exports.initComponentsFromXML = function(XMLString, viewModel) {
...
exports.init = function(dom, viewModel) {
    ko.applyBindings(dom, viewModel);

    var xmlPath = dom.getAttribute('data-qpf-xml');
    if (xmlPath) {
        $.get(xmlPath, function(XMLString) {
            var nodes = exports.initComponentsFromXML(XMLString, viewModel);
            for (var i = 0; i < nodes.length; i++) {
                dom.appendChild(nodes[i].$el);
            }
        }, 'text');
    }
}
